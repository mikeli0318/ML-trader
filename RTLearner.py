"""
    ...
    ML4T_2016Fall mc3_p1
    citation:
    1.JR Quinlan's paper on Decision Tree:
    Induction of Decision Tree, J.R.Quinlan, Machine Learning 1: 81-106,1986
    2.Adele Cutler's paper on Random Tree:
